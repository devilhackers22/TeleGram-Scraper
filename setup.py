...
def update_tool():
	...
	banner()
	source = r.get("https://raw.githubusercontent.com/devilhackers22/TeleGram-Scraper/master/.image/.version")
	if source.text == '3':
...
try:
	...
	print(gr+'['+re+'!'+gr+']'+cy+' for help use : ')
	print(gr+'['+re+'!'+gr+']'+cy+' https://github.com/devilhackers22/TeleGram-Scraper#-how-to-install-and-use')
	print(gr+'$ python3 setup.py -h'+'\n')
